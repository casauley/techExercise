...
public class RemoveSauley extends HttpServlet {
   ...
   void search(String keyword, HttpServletResponse response) throws IOException {
      ...
      try {
         ...
         if (keyword.isEmpty()) {
        	 out.println("Nothing was removed. Please enter an id to remove an item next time.");
         } else {
            String selectSQL = "DELETE FROM MyTableSauleyToDoList WHERE id = ?";
            String itemID = keyword;
