...
public class InsertSauley extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String insertSql = " INSERT INTO MyTableSauleyToDoList (id, ITEM) values (default, ?)";

      try {
    	  // Grab item to insert
         DBConnectionSauley.getDBConnection();
         connection = DBConnectionSauley.connection;
         PreparedStatement preparedStmtInsert = connection.prepareStatement(insertSql);
         preparedStmtInsert.setString(1, item);
         ...
         //preparedStmtDisplay.executeQuery();
